...
def generate_launch_description():
    ...
    controllers_file = PathJoinSubstitution(
        [FindPackageShare("openarm_bimanual_moveit_config"), "config", "ros2_controllers.yaml"]
    )
    servo_yaml = load_yaml("openarm_bimanual_moveit_config",
    ...
    # Aumentar el padding global del robot para mantener separación con obstáculos
    moveit_config.planning_scene_monitor['robot_link_padding'] = 0.00  # <--- AÑADIDO AQUÍ
